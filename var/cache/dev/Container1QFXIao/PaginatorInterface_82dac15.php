...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer97c16 && ($this->initializer97c16->__invoke($valueHolder64ad2, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer97c16) || 1) && $this->valueHolder64ad2 = $valueHolder64ad2;

        if ($this->valueHolder64ad2 === $returnValue = $this->valueHolder64ad2->paginate($target, $page, $limit, $options)) {
            return $this;
        }
