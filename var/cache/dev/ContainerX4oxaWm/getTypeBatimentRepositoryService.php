 ...
 */
class getTypeBatimentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeBatimentRepository' shared autowired service.
     *
     * @return \App\Repository\TypeBatimentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeBatimentRepository.php';

        return $container->privates['App\\Repository\\TypeBatimentRepository'] = new \App\Repository\TypeBatimentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
