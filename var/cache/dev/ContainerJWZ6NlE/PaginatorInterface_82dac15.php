...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer8a9a4 && ($this->initializer8a9a4->__invoke($valueHolder5f7de, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer8a9a4) || 1) && $this->valueHolder5f7de = $valueHolder5f7de;

        if ($this->valueHolder5f7de === $returnValue = $this->valueHolder5f7de->paginate($target, $page, $limit, $options)) {
            return $this;
        }
