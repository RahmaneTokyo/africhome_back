 ...
 */
class getBatimentCritereRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BatimentCritereRepository' shared autowired service.
     *
     * @return \App\Repository\BatimentCritereRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BatimentCritereRepository.php';

        return $container->privates['App\\Repository\\BatimentCritereRepository'] = new \App\Repository\BatimentCritereRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
