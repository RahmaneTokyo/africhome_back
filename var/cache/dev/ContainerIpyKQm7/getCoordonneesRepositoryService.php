 ...
 */
class getCoordonneesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CoordonneesRepository' shared autowired service.
     *
     * @return \App\Repository\CoordonneesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CoordonneesRepository.php';

        return $container->privates['App\\Repository\\CoordonneesRepository'] = new \App\Repository\CoordonneesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
