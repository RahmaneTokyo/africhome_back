 ...
 */
class getMontantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MontantRepository' shared autowired service.
     *
     * @return \App\Repository\MontantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MontantRepository.php';

        return $container->privates['App\\Repository\\MontantRepository'] = new \App\Repository\MontantRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
