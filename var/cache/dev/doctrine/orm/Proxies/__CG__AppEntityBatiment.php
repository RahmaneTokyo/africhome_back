...
class Batiment extends \App\Entity\Batiment implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function getTaxes(): \Doctrine\Common\Collections\Collection
    {
     ...
     * {@inheritDoc}
     */
    public function addTax(\App\Entity\Taxe $tax): \App\Entity\Batiment
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTax', [$tax]);

        return parent::addTax($tax);
    }

    /**
     * {@inheritDoc}
     */
    public function removeTax(\App\Entity\Taxe $tax): \App\Entity\Batiment
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTax', [$tax]);

        return parent::removeTax($tax);
    }
     ...
     * {@inheritDoc}
     */
    public function addPaiement(\App\Entity\Paiement $paiement): \App\Entity\Batiment
    {
     ...
     * {@inheritDoc}
     */
    public function removePaiement(\App\Entity\Paiement $paiement): \App\Entity\Batiment
    {
