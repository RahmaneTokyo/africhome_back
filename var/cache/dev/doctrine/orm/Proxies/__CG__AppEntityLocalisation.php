...
class Localisation extends \App\Entity\Localisation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Localisation' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Localisation' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Localisation' . "\0" . 'typeLocalisation', '' . "\0" . 'App\\Entity\\Localisation' . "\0" . 'niveau', '' . "\0" . 'App\\Entity\\Localisation' . "\0" . 'father', '' . "\0" . 'App\\Entity\\Localisation' . "\0" . 'zipCode', '' . "\0" . 'App\\Entity\\Localisation' . "\0" . 'batiments', '' . "\0" . 'App\\Entity\\Localisation' . "\0" . 'incidents'];
        }
     ...
     * {@inheritDoc}
     */
    public function addIncident(\App\Entity\Incident $incident): \App\Entity\Localisation
    {
     ...
     * {@inheritDoc}
     */
    public function removeIncident(\App\Entity\Incident $incident): \App\Entity\Localisation
    {
